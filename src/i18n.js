...
export const i18n = {
  he: {
    ...
    rotateLeft: 'סובב שמאלה 90°',
    rotateRight: 'סובב ימינה 90°',
    flipHorizontal: 'שקף לרוחב',
    flipVertical: 'שקף לאורך',
    resetOrientation: 'החזר לכיוון המקורי',
    home: 'בית',
    drainage: 'קולטן',
    newSketch: 'שרטוט חדש',
    zoomIn: 'הגדל זום',
    ...
    toasts: {
      ...
      orientation: (deg, flipped) => `תצוגה: סיבוב ${deg}°${flipped ? ' + שיקוף' : ''}`,
      orientationReset: 'התצוגה חזרה לכיוון המקורי',
  ...
  en: {
    ...
    toasts: {
      ...
      orientation: (deg, flipped) => `View: rotated ${deg}°${flipped ? ' + mirrored' : ''}`,
      orientationReset: 'View back to the drawn orientation',
